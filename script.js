...
document.getElementById("helpBtn").addEventListener("click", () => {
    ...
    window.open("https://github.com/Dalilant8/gradient-blob-generator/tree/main?tab=readme-ov-file#-gradient-generator-control-guide", "_blank");
});

document.getElementById("About").addEventListener("click", () => {
    // Replace the link below with your actual GitHub repo link
    window.open("https://github.com/Dalilant8/gradient-blob-generator", "_blank");
});
